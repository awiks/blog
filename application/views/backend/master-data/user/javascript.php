<script type="text/javascript">
	...
	function tampildata()
	{
		$("#myTable").DataTable({
	        ...
	        "serverSide": false,
	        "ajax" :{
	          url : "<?= site_url('cpanel/master-data/user/ajax') ?>",
	          type: "POST",
	          dataType: "json",
	        },
	        "columns" : [{ "data" : "nomor" }, 
	...
	$('body').on('click', '.add', function(event) {
	    ...
	    $.ajax({
	      url: '<?= site_url('cpanel/master-data/user/modal-add') ?>',
	      type: 'post',
	      dataType: 'html',
	      beforeSend: function(){   
	...
	$('body').on('submit', '#simpan', function(event) {
      ...
      $.ajax({
        url: '<?= site_url('cpanel/master-data/user/simpan') ?>',
        type: 'post',
        dataType: 'html',
        ...
        success : function(data)
        {
          ...
          {
            toastr.warning('Maaf email yang anda masukan sudah ada.');
          }
          else
          {
...
$('body').on('click', '.edit', function(event) {
  ...
  /* Act on the event */
    ...
    $.ajax({
      url: '<?= site_url('cpanel/master-data/user/modal-edit') ?>',
      type: 'post',
      dataType: 'html',
      data: {id: id,},
      beforeSend: function(){   
 ...
 $('body').on('submit', '#perbarui', function(event) {
    ...
    $.ajax({
      url: '<?= site_url('cpanel/master-data/user/perbarui') ?>',
      type: 'post',
      dataType: 'html',
      data: new FormData(this),
      contentType: false,       
  ...
  $('body').on('click', '.delete', function(event) {
    ...
    $.ajax({
      url: '<?= base_url('cpanel/master-data/user/delete') ?>',
      type: 'post',
      dataType: 'html',
      data: {id:id,},
      beforeSend: function(){   
 ...
 $('body').on('click', '.hapus_data', function(event) {
   ...
   /* Act on the event */
    ...
    $.ajax({
        url: '<?= base_url('cpanel/master-data/user/hapus') ?>',
        type: 'post',
        dataType: 'html',
        data: {id:id,},
        beforeSend: function(){   
