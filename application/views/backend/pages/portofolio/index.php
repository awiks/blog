<div class="card shadow mb-4">
    <div class="card-header py-2">
        ...
        <a href="<?= base_url('cpanel/pages/portofolio/create')?>" 
   ...
   <?= $this->session->flashdata('success') ?>
    ...
    <?php if (count($portofolio) > 0): ?>
        <?php foreach ($portofolio as $key => $item): ?>
        <div class="row mb-3">
            ...
            <div class="col-md-7">
                ...
                <div class="btn-group">
                    <a href="<?= base_url('/cpanel/pages/portofolio/edit/'.$item->slug.'') ?>" class="btn btn-outline-secondary btn-sm">Edit</a>
