        ...
        <div class="row justify-content-center">
          <div class="col-lg-8">
            ...
            <div class="card box-shadow mb-3">
                <div class="card-body">
                  <h3 class="mb-3">Cari artikel lainnya :</h3>
              
                    <form action="<?= base_url('/key')?>" method="get">
                   
                    <div class="input-group input-group-lg">
                      <input type="text" name="search" value="<?= $key ?>" class="form-control" placeholder="ketik disini">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 pl-2 pr-2">
                    <div class="card box-shadow mb-4 move-up-hover">
                        ...
                        <div class="card-footer">
                            ...
                            <span>
                                <a href="<?= base_url('/author/'.$blog->slug_u.'') ?>"><?= $blog->name ?></a>
                            </span>
                        </div>
                    </div>
                </div>
